...
$articulos=mysqli_query($conexion,"SELECT id_grupos,grupo,semestre,carrera,dias_tutoria,hora_inicio,hora_fin,periodo FROM grupos  where semestre >=7;");
...
$inicio=0;
$busqueda=mysqli_query($conexion,"SELECT id_grupos,grupo,semestre,carrera,dias_tutoria,hora_inicio,hora_fin,periodo FROM grupos WHERE semestre >=7  LIMIT $inicio,$registros;");
...
<h1>
LISTA DE GRUPOS CON TUTORIAS FINALIZADAS
</section>
